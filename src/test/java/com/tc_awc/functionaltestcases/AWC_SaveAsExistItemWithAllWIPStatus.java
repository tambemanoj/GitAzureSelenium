...
/*2.3 Test creation and test automation to test the ability to 
      enable using save-as to apply a build WIP status (create, revise, save-as)
 * */

public class AWC_SaveAsExistItemWithAllWIPStatus extends TestBase {
	...
	public void saveAsItem_GeneralWIP(String itemStatus, String itemStatus_P0WIP, String itemStatus__P1WIP,
		...
		hp.search_saveAs();
		saf.saveItem(itemStatus);

	}

	@Test(priority = 2, dataProvider = "getData")
	public void saveAsItem_P0WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus__P1WIP,
			String itemStatus_P2WIP, String itemStatus__P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_P0WIP);

	}

	@Test(priority = 3, dataProvider = "getData")
	public void saveAsItem_P1WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus_P1WIP,
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_P1WIP);

	}

	@Test(priority = 4, dataProvider = "getData")
	public void saveAsItem_P2WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus_P1WIP,
			String itemStatus_P2WIP, String itemStatus_P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_P2WIP);

	}

	@Test(priority = 5, dataProvider = "getData")
	public void saveAsItem_P3WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus_P1WIP,
			String itemStatus_P2WIP, String itemStatus_P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_P3WIP);

	}

	@Test(priority = 6, dataProvider = "getData")
	public void saveAsItem_EVT1WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus_P1WIP,
			String itemStatus_P2WIP, String itemStatus_P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_EVT1WIP);

	}

	@Test(priority = 7, dataProvider = "getData")
	public void saveAsItem_EVT2WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus_P1WIP,
			String itemStatus_P2WIP, String itemStatus_P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_EVT2WIP);
	}

	@Test(priority = 8, dataProvider = "getData")
	public void saveAsItem_EVT3WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus_P1WIP,
			String itemStatus_P2WIP, String itemStatus_P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_EVT3WIP);

	}

	@Test(priority = 9, dataProvider = "getData")
	public void saveAsItem_DVT1WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus_P1WIP,
			String itemStatus_P2WIP, String itemStatus_P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_DVT1WIP);

	}

	@Test(priority = 10, dataProvider = "getData")
	public void saveAsItem_DVT2WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus_P1WIP,
			String itemStatus_P2WIP, String itemStatus_P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_DVT2WIP);

	}

	@Test(priority = 11, dataProvider = "getData")
	public void saveAsItem_DVT3WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus_P1WIP,
			String itemStatus_P2WIP, String itemStatus_P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_DVT3WIP);

	}

	@Test(priority = 12, dataProvider = "getData")
	public void saveAsItem_PVT1WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus__P1WIP,
			String itemStatus_P2WIP, String itemStatus__P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_PVT1WIP);

	}

	@Test(priority = 13, dataProvider = "getData")
	public void saveAsItem_PVT2WIP(String itemStatus, String itemStatus_P0WIP, String itemStatus__P1WIP,
			String itemStatus_P2WIP, String itemStatus__P3WIP, String itemStatus_EVT1WIP, String itemStatus_EVT2WIP,
			String itemStatus_EVT3WIP, String itemStatus_DVT1WIP, String itemStatus_DVT2WIP, String itemStatus_DVT3WIP,
			String itemStatus_PVT1WIP, String itemStatus_PVT2WIP) throws Throwable {
		wt = new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(30));
		...
		wt.until(ExpectedConditions.titleContains("Teamcenter - Home"));
		hp.search_saveAs();
		saf.saveItem(itemStatus_PVT2WIP);
